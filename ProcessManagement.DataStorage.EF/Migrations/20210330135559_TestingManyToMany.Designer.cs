...
namespace ProcessManagement.DataStorage.EF.Migrations
{
    ...
    [Migration("20210330135559_TestingManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Process.Editor.Elements.ProcessPoint", b =>
                {
                    ...
                    b.Property<int?>("ProcessGroupModelProcessGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProcessGroupModelProcessGroupId");
            ...
            modelBuilder.Entity("Process.Editor.Elements.TableA", b =>
                {
            ...
            modelBuilder.Entity("Process.Editor.Elements.TableAB", b =>
                {
                    b.Property<int>("TableAId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Process.Editor.Elements.TableB", b =>
                {
                    b.Property<int>("TableBId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Process.Editor.Elements.TableAB", b =>
                {
                    b.HasOne("Process.Editor.Elements.TableA", "TableA")
                        .WithMany("TableAB")
                        .HasForeignKey("TableAId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Process.Editor.Elements.TableB", "TableB")
                        .WithMany("TableAB")
